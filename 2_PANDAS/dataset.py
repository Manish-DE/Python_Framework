...
data ={
    "Name": ['Rahul', 'Rohit', 'Ravi','Aditi', 'Manish', 'Manas', 'Sita', 'Gita', 'Riya'],
    "Age": [25, 30, 35, 28, 32, 29, 26, 31, 27],
    "City": ['Delhi', 'Mumbai', 'Bangalore', 'Chennai', 'Kolkata', 'Hyderabad', 'Pune', 'Ahmedabad', 'Jaipur'],
